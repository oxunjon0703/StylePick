...
const productImages = ["/mk.png", "/mk1.png", "/mk2.png", "/mk3.png"];

const mainImage = "/aaa.png";
          ...
          <div className="flex-1 flex flex-col justify-between max-w-lg h-[800px] py-10">
            <div className="space-y-15 flex-1 flex flex-col justify-center">
              ...
              <div className="flex flex-col gap-3 text-gray-700 text-base">
                <span>
                  <b>Mahsulot rangi:</b> Ko&apos;k
                </span>
                {/* Ranglar doiralari */}
                <div className="flex gap-4 py-2">
                  <span className="w-6 h-6 rounded-full bg-[#456582] ring-2 ring-black border border-gray-300"></span>
                  <span className="w-6 h-6 rounded-full bg-[#B6B6B6] border border-gray-300"></span>
                  <span className="w-6 h-6 rounded-full bg-[#93887E] border border-gray-300"></span>
                  <span className="w-6 h-6 rounded-full bg-[#273F8E] border border-gray-300"></span>
                  <span className="w-6 h-6 rounded-full bg-[#7A93AD] border border-gray-300"></span>
                </div>
                <span>
                  <b>Mahsulot razmeri: M</b>
                </span>
                ...
                <div className="flex gap-2 py-2">
                  ...
                  <span className="px-3 py-1 rounded-lg border-2 border-gray-300 bg-white text-gray-700 font-semibold cursor-pointer">
                    S
                  </span>
                  <span className="px-3 py-1 rounded-lg border border-gray-300 bg-black text-white font-semibold cursor-pointer">
                    M
                  </span>
                  <span className="px-3 py-1 rounded-lg border border-gray-300 bg-white text-gray-700 font-semibold cursor-pointer">
                    L
