        ...
        {tariff.map((item) => (
          ...
          >
            <div className="w-full border border-gray-300 rounded-xl shadow-md p-4 mb-4 bg-white flex-1 flex flex-col">
              <h3 className="text-xl font-bold mb-4 text-primary text-black text-center">
                {item.title}
              </h3>
              <div className="text-3xl font-extrabold mb-2 text-black text-center flex items-end justify-center w-full">
                <span className="text-5xl">{item.price.split(".")[0]}</span>
                <span className="text-xl ml-1">
                  .{item.price.split(".")[1]}
                </span>
              </div>
              <div className="text-base mb-4 text-black text-center">
                {item.price_year}
              </div>
